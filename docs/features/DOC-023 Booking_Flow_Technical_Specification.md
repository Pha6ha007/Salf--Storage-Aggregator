...
```json
{
  "id": 101,
  "name": "СкладОК Выхино",
  "address": "Dubai, Al Quoz проспект, 75к2",
  "coordinates": {
    "lat": 55.709617,
    "lng": 37.815673
  },
...
│                                                              │
│  ┌────────────────────────────────────────┐                 │
│  │  БОКС M (5 м²)          4 500 AED /мес  │  🏆 AI рекомендует│
│  │  ┌─────────┐                          │                 │
...
│  💰 РАСЧЁТ СТОИМОСТИ                                         │
│                                                               │
│  Цена за месяц:                     4 500 AED                   │
│  Срок аренды:                       × 6 месяцев              │
│  ─────────────────────────────────────────────               │
│  Стоимость аренды:                 27 000 AED                   │
│  Скидка (за 6+ месяцев):           - 2 700 AED  (10%)          │
│  Залог (возвратный):              + 4 500 AED                   │
│  ─────────────────────────────────────────────               │
│  ИТОГО к оплате:                   28 800 AED                   │
│                                                               │
...
│                                                           │
│  • Бокс M на 1 этаже — 4 500 AED /мес  [Выбрать]          │
│  • Бокс L на 2 этаже — 6 200 AED /мес  [Выбрать]          │
│                                                           │
...
│  │ ─────────────────────      │  │ ● 3 мес ○ 6 мес ○ 12 мес        ││
│  │ Аренда:       27 000 AED      │  │                                  ││
│  │ Скидка:      - 2 700 AED      │  │ Окончание: 15.06.2026           ││
│  │ Залог:       + 4 500 AED      │  │                                  ││
│  │ ─────────────────────      │  │ ────────────────────────────────││
│  │ ИТОГО:        28 800 AED      │  │                                  ││
│  │                             │  │ ДОПОЛНИТЕЛЬНО                    ││
  ...
  "data": {
    "booking": {
      ...
      "warehouse": {
        "id": 101,
        "name": "СкладОК Выхино",
        "address": "Dubai, Al Quoz пр-т, 75к2"
      },
      "box": {
        "id": 501,
        "size": "M",
...
│     Бокс M (5м²) | 28 800AED  | Начало: 15.12.2025                │
│     [Связаться] [Подробнее]                                      │
│                                                                   │
│  ⚠️ BK-20251211-0035 - Noura Abdullah                            │
│     Создана 8 часов назад | Lead Score: 72                      │
│     Бокс S (2м²) | 9 600AED  | Начало: 14.12.2025                 │
│     [Связаться] [Подробнее]                                      │
│                                                                   │
│  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  │
│                                                                   │
...
```
Заявка #BK-20251211-0042 создана. СкладОК Выхино, бокс M (5м²), 28 800AED . 
...
Мы получили вашу оплату 28 800 AED .
...
BK-0042, Ahmed Al-Rashid, 28800AED , Score: 85. 
...
```json
{
  ...
  "data": {
    "pricing": {
      ...
      "price_vs_market": 2.1,
      "confidence": 0.85,
      "reasoning": "Ваша цена на 4% ниже рыночной. Рекомендуем повысить до 4800AED /мес. При высокой загруженности склада (85%) можно установить премиум-цену.",
      "recommendations": [
        "Увеличьте базовую цену до 4800AED ",
...
|------------------|-----------------|-----------------|
| Static pricing | 45% | 202,500AED /year |
| Manual adjustment | 52% | 234,000AED /year |
| AI dynamic pricing | 58% | 261,000AED /year |
...
| High-value first booking | +10 | Первая заявка >50kAED  |
...
1. Бокс M (5 м²), 2 этаж
   Обычная цена: 4500 AED /мес
   Ваша цена: 3825 AED /мес (-15%)
   [Забронировать со скидкой]

2. Бокс L (7 м²), 1 этаж  
   Обычная цена: 5500 AED /мес
   Ваша цена: 4675 AED /мес (-15%)
   [Забронировать со скидкой]
...
| No alternatives available | Full refund + 500AED  bonus for next booking |
...
def validate_booking_data_contextual(data: dict, user: User = None) -> dict:
    ...
    if estimated_total > 50000:
        if not user:
            errors['authentication'] = "Для бронирований свыше 50 000AED  требуется регистрация"
